  ...
  return (
    <div className="bg-black h-auto min-h-[124.5px] w-full relative pb-4 md:pb-0 md:h-[124.5px]">
      ...
      <div className="hidden md:block">
        <button 
          className="absolute block cursor-pointer font-['Inter:Medium',sans-serif] font-medium h-[24px] leading-[0] left-[190px] not-italic text-[16px] text-[#e0cb23] top-[56px] w-[62px] hover:text-[#e0cb23] transition-colors"
        >
  ...
  return (
    <div className="relative w-16 h-16 md:w-24 md:h-24" data-name="Icon/Play">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 96 96">
        <g id="Icon/Play">
          <g id="Base"></g>
          <path clipRule="evenodd" d={svgPaths.p3c121800} fill="var(--fill-0, white)" fillRule="evenodd" id="Mask" />
        </g>
      </svg>
    </div>
  );
...
function Main() {
  return (
    <div className="w-full h-auto min-h-[364px] bg-black relative pb-8 md:pb-0 md:h-[364px]" data-name="MAIN">
      {/* Logo */}
      <div 
...
function IconJamIconsOutlineLogosLinkedin() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / linkedin">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / linkedin">
          <path d={svgPaths.p37350180} fill="var(--fill-0, #697077)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function IconJamIconsOutlineLogosTwitter() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / twitter">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / twitter">
          <path d={svgPaths.p837b900} fill="var(--fill-0, #697077)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function IconJamIconsOutlineLogosInstagram() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / instagram">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / instagram">
          <path d={svgPaths.p3d68d900} fill="var(--fill-0, #697077)" id="Vector" />
          <path d={svgPaths.p2fa2a100} fill="var(--fill-0, #697077)" id="Vector_2" />
          <path d={svgPaths.p195b580} fill="var(--fill-0, #697077)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function IconJamIconsOutlineLogosFacebook() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / facebook">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / facebook">
          <path d={svgPaths.p229a3700} fill="var(--fill-0, #697077)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function IconJamIconsOutlineLogosLinkedin1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / linkedin">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / linkedin">
...
function IconJamIconsOutlineLogosTwitter1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / twitter">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / twitter">
...
function IconJamIconsOutlineLogosInstagram1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / instagram">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / instagram">
...
function IconJamIconsOutlineLogosFacebook1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / facebook">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / facebook">
...
function IconJamIconsOutlineLogosLinkedin2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / linkedin">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / linkedin">
...
function IconJamIconsOutlineLogosTwitter2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / twitter">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / twitter">
...
function IconJamIconsOutlineLogosInstagram2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / instagram">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / instagram">
...
function IconJamIconsOutlineLogosFacebook2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / facebook">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / facebook">
...
function IconJamIconsOutlineLogosLinkedin3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / linkedin">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / linkedin">
...
function IconJamIconsOutlineLogosTwitter3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / twitter">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / twitter">
...
function IconJamIconsOutlineLogosInstagram3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / instagram">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / instagram">
...
function IconJamIconsOutlineLogosFacebook3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon / jam-icons / outline & logos / facebook">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon / jam-icons / outline & logos / facebook">
...
function Group() {
  return (
    <div className="absolute contents leading-[0] left-[301px] not-italic text-center top-[50px]">
      <div className="absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[50px] left-[732px] text-[35px] text-black top-[100px] translate-x-[-50%] translate-y-[-50%] w-[862px]">
        <p className="mb-0">{`Trusted by Thousands of `}</p>
        <p>Happy Customer</p>
      </div>
      <div className="absolute flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[67.417px] justify-center left-[710.45px] text-[#1a202c] text-[18px] top-[219.71px] translate-x-[-50%] translate-y-[-50%] w-[529.478px]">
        <p className="leading-[1.5]">“Here’s what our happy participants are saying about their experience.”</p>
      </div>
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute contents left-[74px] top-[310.67px]">
      <div className="absolute bg-[#486284] blur-[57px] filter h-[300.806px] left-[114.82px] opacity-[0.06] rounded-[10px] top-[310.67px] w-[318.353px]" />
      <div className="absolute bg-[#6b6b6b] h-[230px] left-[74px] rounded-[10px] top-[310.67px] w-[400px]" />
      <div className="absolute left-[104px] size-[50px] top-[340.67px]">
      ...
      <div className="absolute left-[115px] size-[40px] top-[340.22px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
          <circle cx="20" cy="20" fill="var(--fill-0, #DDE0E4)" id="Ellipse 2519" r="20" />
        </svg>
      </div>
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents left-[520px] top-[311px]">
      <div className="absolute bg-[#486284] blur-[57px] filter h-[300.806px] left-[560.82px] opacity-[0.06] rounded-[10px] top-[311px] w-[318.353px]" />
      <div className="absolute bg-[#6b6b6b] h-[230px] left-[520px] rounded-[10px] top-[311px] w-[400px]" />
      <div className="absolute left-[550px] size-[50px] top-[341px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Ellipse 175"></g>
        </svg>
      </div>
      ...
      <div className="absolute left-[561px] size-[40px] top-[340.55px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
          <circle cx="20" cy="20" fill="var(--fill-0, #DDE0E4)" id="Ellipse 2519" r="20" />
        </svg>
      </div>
...
function Group3() {
  return (
    <div className="absolute contents left-[966px] top-[311px]">
      <div className="absolute bg-neutral-600 blur-[57px] filter h-[300.806px] left-[1006.82px] opacity-[0.06] rounded-[10px] top-[311px] w-[318.353px]" />
      <div className="absolute bg-[#6b6b6b] h-[230px] left-[966px] rounded-[10px] top-[311px] w-[400px]" />
      <div className="absolute left-[996px] size-[50px] top-[341px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Ellipse 175"></g>
        </svg>
      </div>
      ...
      <div className="absolute left-[1007px] size-[40px] top-[340.55px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
          <circle cx="20" cy="20" fill="var(--fill-0, #DDE0E4)" id="Ellipse 2519" r="20" />
        </svg>
      </div>
...
function EvaArrowBackFill() {
  return (
    <div className="absolute left-[13px] size-[30px] top-[406px]" data-name="eva:arrow-back-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g id="eva:arrow-back-fill">
          <path d={svgPaths.p143f6f80} fill="var(--fill-0, #1A202C)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function EvaArrowBackFill1() {
  return (
    <div className="relative size-[30px]" data-name="eva:arrow-back-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g id="eva:arrow-back-fill">
          <path d={svgPaths.p143f6f80} fill="var(--fill-0, #486284)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Dots() {
  return (
    <div className="absolute inset-[83.75%_45.35%_14.42%_45.28%]" data-name="Dots">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 135 15">
        <g id="Dots">
          <path d={svgPaths.p3f5aabf0} fill="var(--fill-0, #141416)" id="Dot" />
          <path d={svgPaths.p23afbb00} fill="var(--fill-0, #E1E5EE)" id="Dot_2" />
          <path d={svgPaths.p1e90a580} fill="var(--fill-0, #E1E5EE)" id="Dot_3" />
          <path d={svgPaths.p23873c00} fill="var(--fill-0, #E1E5EE)" id="Dot_4" />
          <path d={svgPaths.p389c0a00} fill="var(--fill-0, #E1E5EE)" id="Dot_5" />
        </g>
      </svg>
    </div>
  );
...
function Group4() {
  return (
    <div className="absolute contents leading-[0] left-[301px] not-italic text-center top-[50px]">
      <div className="absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[50px] left-[732px] text-[35px] text-white top-[100px] translate-x-[-50%] translate-y-[-50%] w-[862px]">
        <p className="mb-0">{`Trusted by Thousands of `}</p>
        <p>Happy Customer</p>
      </div>
      <div className="absolute flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[67.417px] justify-center left-[710.45px] text-[#d9d9d9] text-[18px] top-[219.71px] translate-x-[-50%] translate-y-[-50%] w-[529.478px]">
        <p className="leading-[1.5]">“Here’s what our happy participants are saying about their experience.”</p>
      </div>
    </div>
  );
...
function EvaArrowBackFill2() {
  return (
    <div className="absolute left-[13px] size-[30px] top-[406px]" data-name="eva:arrow-back-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g id="eva:arrow-back-fill">
          <path d={svgPaths.p143f6f80} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
