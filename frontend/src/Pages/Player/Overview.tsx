        ...
        <Card className="bg-white mb-6">
          <CardContent className="p-6 flex items-center gap-6">
            ...
            <div className="flex gap-3">
              <Button variant="outline" className="border-black">Settings</Button>
          ...
          <Card className="bg-white">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="font-semibold text-black">Monthly Goal Progress</p>
                  <p className="text-sm text-gray-600">14 of 20 hours this month</p>
                </div>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div className="bg-[#e0cb23] h-3 rounded-full" style={{ width: '70%' }}></div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="text-2xl">🏆</div>
                <div>
                  <p className="font-semibold text-black">Achievements</p>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-yellow-500">🏆</span>
                  <span className="text-sm">10 Hours Played</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-yellow-500">🏆</span>
                  <span className="text-sm">Perfect Week</span>
                </div>
              </div>
            </CardContent>
          </Card>
